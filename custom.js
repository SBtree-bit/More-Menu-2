window.snake.more_menu = function(e) {
  ...
  // micro
  let img = new Image;
  img.src = 'https://github.com/SBtree-bit/More-Menu-2/blob/main/micro-1.png?raw=true';
  img.width = 47;
  img.height = 47;
  ...
  // tiny
  img = new Image;
  img.src = 'https://github.com/SBtree-bit/More-Menu-2/blob/main/tiny-1.png?raw=true';
  img.width = 47;
  img.height = 47;
  document.querySelector('#size').appendChild(img);
  ...
  // super big
  img = new Image;
  img.src = 'https://github.com/SBtree-bit/More-Menu-2/blob/main/superbig-1.png?raw=true';
  img.width = 47;
  img.height = 47;
  document.querySelector('#size').appendChild(img);
  ...
  // ultra big
  img = new Image;
  img.src = 'https://github.com/SBtree-bit/More-Menu-2/blob/main/ultrabig-1.png?raw=true';
  img.width = 47;
  img.height = 47;
  document.querySelector('#size').appendChild(img);
  ...
  // humongous
  img = new Image;
  img.src = 'https://raw.githubusercontent.com/SBtree-bit/More-Menu-2/main/humoungus-1.png';
  img.width = 47;
  img.height = 47;
  document.querySelector('#size').appendChild(img);
  ...
  // too big
  img = new Image;
  img.src = 'https://github.com/SBtree-bit/More-Menu-2/blob/main/toobigg-1.png?raw=true';
  img.width = 47;
  img.height = 47;
  document.querySelector('#size').appendChild(img);
  ...
  // purgatory
  img = new Image;
  img.src = 'https://github.com/SBtree-bit/More-Menu-2/blob/main/purgatory.png?raw=true';
  img.width = 47;
  img.height = 47;
  document.querySelector('#size').appendChild(img);
  ...
  // lightning
  img = new Image;
  img.src = 'https://raw.githubusercontent.com/SBtree-bit/More-Menu-2/main/bolt.png';
  img.width = 47;
  img.height = 47;
  img.class = 'DqMRee SsAred';
  document.querySelector('#speed').appendChild(img);
  ...
  // snail
  img = new Image;
  img.src = 'https://github.com/SBtree-bit/More-Menu-2/blob/main/snai.png?raw=true';
  img.width = 47;
  img.height = 47;
  img.class = 'DqMRee SsAred';
  document.querySelector('#speed').appendChild(img);
  ...
  img = new Image;
  img.src = 'https://raw.githubusercontent.com/SBtree-bit/More-Menu-2/main/bru.png';
  img.width = 47;
  img.height = 47;
  img.class = 'DqMRee SsAred';
  document.querySelector('#speed').appendChild(img);
  ...
  // desert bus
  img = new Image;
  img.src = 'https://github.com/SBtree-bit/More-Menu-2/blob/main/desert_bus.png?raw=true';
  img.width = 47;
  img.height = 47;
  img.class = 'DqMRee SsAred';
  document.querySelector('#speed').appendChild(img);
  ...
  // bullet
  img = new Image;
  img.src = 'https://raw.githubusercontent.com/SBtree-bit/More-Menu-2/main/bullet.png';
  img.width = 47;
  img.height = 47;
  img.class = 'DqMRee SsAred';
  document.querySelector('#speed').appendChild(img);
  ...
  // hyperbullet
  img = new Image;
  img.src = 'https://github.com/SBtree-bit/More-Menu-2/blob/main/hyperbullet.png?raw=true';
  img.width = 47;
  img.height = 47;
  img.class = 'DqMRee SsAred';
  document.querySelector('#speed').appendChild(img);
  ...
  // ultrabullet
  img = new Image;
  img.src = 'https://github.com/SBtree-bit/More-Menu-2/blob/main/no.png?raw=true';
  img.width = 47;
  img.height = 47;
  img.class = 'DqMRee SsAred';
  document.querySelector('#speed').appendChild(img);
  ...
  // yeetbullet
  img = new Image;
  img.src = 'https://raw.githubusercontent.com/SBtree-bit/More-Menu-2/main/aaaaaaaaa.png';
  img.width = 47;
  img.height = 47;
  img.class = 'DqMRee SsAred';
  document.querySelector('#speed').appendChild(img);
  ...
  // eternity
  img = new Image;
  img.src = 'https://raw.githubusercontent.com/SBtree-bit/More-Menu-2/main/eternal.png';
  img.width = 47;
  img.height = 47;
  img.class = 'DqMRee SsAred';
  document.querySelector('#speed').appendChild(img);
  ...
  // ultradeath
  img = new Image;
  img.src = 'https://github.com/SBtree-bit/More-Menu-2/blob/main/unknown.png?raw=true';
  img.width = 47;
  img.height = 47;
  img.class = 'DqMRee SsAred';
  document.querySelector('#speed').appendChild(img);
  ...
  // 13
  img = new Image;
  img.src = 'https://github.com/SBtree-bit/More-Menu-2/blob/main/manyapples-1.png?raw=true';
  img.width = 47;
  img.height = 47;
  ...
  // 25
  img = new Image;
  img.src = 'https://raw.githubusercontent.com/SBtree-bit/More-Menu-2/main/appletree-1.png';
  img.width = 47;
  img.height = 47;
  document.querySelector('#count').appendChild(img);
  ...
  // 40 :rolling_eyes:
  img = new Image;
  img.src = 'https://github.com/SBtree-bit/More-Menu-2/blob/main/orchard.png?raw=true'
  img.width = 47;
  img.height = 47;
  document.querySelector('#count').appendChild(img);
  ...
  // 87
  img = new Image;
  img.src = 'https://raw.githubusercontent.com/SBtree-bit/More-Menu-2/main/alotactually.png';
  img.width = 47;
  img.height = 47;
  document.querySelector('#count').appendChild(img);
  ...
  // apple bomb
  img = new Image;
  img.src = 'https://raw.githubusercontent.com/SBtree-bit/More-Menu-2/main/applebomb.png';
  img.width = 47;
  img.height = 47;
  document.querySelector('#count').appendChild(img);
  ...
  // apple nuke
  img = new Image;
  img.src = 'https://raw.githubusercontent.com/SBtree-bit/More-Menu-2/main/applenuke.png';
  img.width = 47;
  img.height = 47;
  document.querySelector('#count').appendChild(img);
